    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, null=True, upload_to='img/user/')),
                ('telefono', models.CharField(blank=True, max_length=10, null=True)),
                ('grado', models.CharField(blank=True, max_length=30, null=True)),
                ...
                ('asignaturas', models.ManyToManyField(blank=True, related_name='UserAsg', to='pedagogica.Asignatura')),
